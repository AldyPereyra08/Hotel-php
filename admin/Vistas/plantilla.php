...
<body class="hold-transition skin-blue sidebar-mini login-page">
  ...
  if(isset($_SESSION["Ingreso"]) && $_SESSION["Ingreso"] == true){
    ...
    if(isset($_GET["url"])){
      ...
      if($_GET["url"] == "inicio" || $_GET["url"] == "ingreso" || $_GET["url"] == "usuarios" ||
         $_GET["url"] == "salir" || $_GET["url"] == "perfil" || $_GET["url"] == "slide" ||
         $_GET["url"] == "nosotros" || $_GET["url"] == "servicios" || $_GET["url"] == "galeria" || 
         $_GET["url"] == "hsimple" || $_GET["url"] == "hdoble" || $_GET["url"] == "htriple" || $_GET["url"] == "hsuite" || $_GET["url"] == "mensajes" || $_GET["url"] == "suscriptores"){
